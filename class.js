...
const movieDetails = new movie("Scotland","Tamil Movies", "PG-14");
...
const movie1 = new movies("Scotland","Tamil Movies");
console.log(movie1);
const movie2 = new movies("Scotland","Tamil Movies","PG-14");
console.log(movie2);
